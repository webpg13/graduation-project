...
<el-breadcrumb :separator-icon="ArrowRight" class="el-breadcrumb_cls">
    <el-breadcrumb-item class="el-breadcrumb-item" :to="{ path: '/AdminForNm' }">论坛</el-breadcrumb-item>
...
const subComment = () => {
  ElMessageBox.confirm(
    ...
    .then(() => {
      axios.post('http://localhost:8081/graduation-project/AdminMenu/ChatRoom/AddChat.php', Qs.stringify({
